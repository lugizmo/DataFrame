...
if(LUGIZMO_BUILD_BENCH)
# Build Benchmarks

    set(LUGIZMO_BENCHMARK_MINIMUM 1.9)
    set(LUGIZMO_BENCHMARK_VERSION v1.9.2)
    ...
    if(NOT TARGET benchmark::benchmark AND NOT TARGET benchmark::benchmark_main)
        ...
        elseif(NOT benchmark_FOUND AND NOT LUGIZMO_DOWNLOAD_BENCHMARK)
            # Couldn't find local package even though should be provided
            message(FATAL_ERROR "Lugizmo DF - Google Benchmark not found! Please install Google Benchmark >= ${LUGIZMO_BENCHMARK_MINIMUM} or enable LUGIZMO_DOWNLOAD_BENCHMARK to fetch it.")
        else()
            ...
            FetchContent_Declare(
                    ...
                    GIT_TAG ${LUGIZMO_BENCHMARK_VERSION}
            )
        ...
        if(BENCHMARK_VERSION VERSION_LESS ${LUGIZMO_BENCHMARK_MINIMUM})
            message(FATAL_ERROR "Benchmark version ${BENCHMARK_VERSION} is less than required ${LUGIZMO_BENCHMARK_MINIMUM}.")
        else()
